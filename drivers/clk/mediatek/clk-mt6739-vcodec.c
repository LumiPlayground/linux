...
static const struct of_device_id of_match_clk_mt6765_vcodec[] = {
	{
		.compatible = "mediatek,mt67639-vcodecsys",
		.data = &venc_desc,
	}, {
		/* sentinel */
	}
};
MODULE_DEVICE_TABLE(of, of_match_clk_mt6739_vcodec);

static struct platform_driver clk_mt6739_vcodec_drv = {
	.probe = mtk_clk_simple_probe,
	.remove_new = mtk_clk_simple_remove,
	.driver = {
		.name = "clk-mt6739-vcodec",
		.of_match_table = of_match_clk_mt6739_vcodec,
	},
};
module_platform_driver(clk_mt6739_vcodec_drv);
MODULE_LICENSE("GPL");
